"""
Valutazione baseline e reranked per MovieLens 1M con LightGCN.
...
CKPT_PATH = Path("LightGCN-Jan-28-2026_20-38-21.pth")
TOP50_CSV = Path("LightGCN_top50_seed2020.csv")
RERANKED_CSV = Path("reranked_ml1m_lightgcn_top10_recbole_like.csv")
TOPKS = [5, 10]
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
OUT_CSV = Path("metrics_ml1m_lightgcn.csv")
