...
def main():
    ...
    ap.add_argument("--inter_path", default="ml-1m.inter")
    ap.add_argument("--item_path", default="ml-1m.item")
    ap.add_argument("--user_path", default="ml-1m.user")
    ap.add_argument("--lightgcn_recs_path", default="LightGCN_top50_seed2020.csv")
    ap.add_argument("--ckpt_path", default="LightGCN-Jan-28-2026_20-38-21.pth")
    ...
    # MovieLens: item_id raw sono numerici, ma li trattiamo come stringhe per uniformità
