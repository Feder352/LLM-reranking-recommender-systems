...
def main():
    ...
    # CKE, come KGCN, usa il dataset KG per le interazioni utente-item
    ap.add_argument("--inter_path", default="MovieLens-KG.inter")
    # I titoli li leggiamo dal file MovieLens standard
    ap.add_argument("--item_path", default="ml-1m.item")
    ap.add_argument("--cke_recs_path", default="CKE_top50_seed2020.csv")
    ap.add_argument("--ckpt_path", default="CKE-Jan-29-2026_14-50-12.pth")
