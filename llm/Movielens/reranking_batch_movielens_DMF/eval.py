"""
Valutazione baseline e reranked per MovieLens 1M con DMF.
...
CKPT_PATH = Path("DMF-Jan-28-2026_20-21-41.pth")
TOP50_CSV = Path("DMF_top50_seed2020.csv")
RERANKED_CSV = Path("reranked_ml1m_dmf_top10_recbole_like.csv")
TOPKS = [5, 10]
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
OUT_CSV = Path("metrics_ml1m_dmf.csv")
