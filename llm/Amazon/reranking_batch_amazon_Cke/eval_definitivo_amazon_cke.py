"""
Valutazione baseline e reranked per Amazon con CKE.
...
CKPT_PATH = Path("CKE-Jan-27-2026_21-12-15.pth")
TOP50_CSV = Path("CKE_top50_seed2020.csv")
RERANKED_CSV = Path("reranked_amazon_cke_top10_recbole_like.csv")
TOPKS = [5, 10]
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
OUT_CSV = Path("metrics_amazon_cke.csv")
...
def get_embeddings(model):
    ...
    Privilegia item_embedding; fallback su entity_embedding.
    """
    def extract(obj):
