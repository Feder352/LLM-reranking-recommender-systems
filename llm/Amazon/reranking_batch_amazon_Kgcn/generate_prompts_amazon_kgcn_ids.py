...
def main():
    ...
    ap.add_argument("--ckpt_path", default="KGCN-Jan-27-2026_21-15-12.pth")
    ...
    # Amazon: item_id raw può essere stringa o numerico, uniformiamo a stringa
