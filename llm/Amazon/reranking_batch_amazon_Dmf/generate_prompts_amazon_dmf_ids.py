...
def main():
    ...
    ap.add_argument("--dmf_recs_path", default="DMF_top50_seed2020.csv")
    ap.add_argument("--ckpt_path", default="DMF-Jan-27-2026_18-03-10.pth")
    ...
    dmf = pd.read_csv(args.dmf_recs_path)
    ...
    if not needed_recs.issubset(dmf.columns):
        raise ValueError(f"{args.dmf_recs_path} colonne mancanti: {list(dmf.columns)}")
